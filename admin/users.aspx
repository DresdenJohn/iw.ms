...
<asp:Content ID="Content1" ContentPlaceHolderID="siteContent" Runat="Server">
    ...
    <div class="col-sm-3 col-md-2 sidebar">
        ...
        <hr />
        <ul class="nav nav-sidebar">
            <li class="active"><a href="users.aspx"><span class="glyphicon glyphicon-user"></span> Users</a></li>
        </ul>
        <hr />
        <ul class="nav nav-sidebar">
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main animated slideInDown">
        ...
        <h3>User Management <asp:LinkButton ID="addUserBtn" runat="server" CssClass="btn btn-primary disabled noCurves">Add New User</asp:LinkButton></h3>
        <hr />
