<%@ Page Title="" Language="VB" MasterPageFile="~/admin/Admin.master" AutoEventWireup="false" CodeFile="editPost.aspx.vb" Inherits="admin_links" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="siteContent" Runat="Server">
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main animated slideInDown">
        ...
        <div class="row">
            <div class="col-lg-8">
                <h3>Post Management > Post Editor</h3>
                <hr />
            </div>
        </div>
