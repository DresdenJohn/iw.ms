<%@ Page Title="" Language="VB" MasterPageFile="~/admin/Admin.master" AutoEventWireup="false" CodeFile="posts.aspx.vb" Inherits="admin_posts" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="siteContent" Runat="Server">
    ...
    <div class="col-sm-3 col-md-2 sidebar">
        ...
        <hr />
        <ul class="nav nav-sidebar">
            <li class="active"><a href="posts.aspx"><span class="glyphicon glyphicon-file"></span> Post Management
                               </a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main animated slideInDown">
        ...
        <h3>Post Management <asp:LinkButton ID="addPostBtn" runat="server" CssClass="btn btn-primary disabled noCurves">Start New Post</asp:LinkButton></h3>
        <hr />
