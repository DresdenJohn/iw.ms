<%@ Page Title="" Language="VB" MasterPageFile="~/admin/Admin.master" AutoEventWireup="false" CodeFile="links.aspx.vb" Inherits="admin_links" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="siteContent" Runat="Server">
    ...
    <div class="col-sm-3 col-md-2 sidebar">
        ...
        <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="links.aspx"><span class="glyphicon glyphicon-link"></span> Links</a></li>
        </ul>
        <hr />
        <ul class="nav nav-sidebar">
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main animated slideInDown">
        ...
        <div class="row">
            <div class="col-lg-8">
                <h3>Link Management <asp:LinkButton ID="addLinkBtn" runat="server" CssClass="btn btn-primary disabled noCurves">Add New</asp:LinkButton></h3>
                <hr />
            </div>
        </div>
